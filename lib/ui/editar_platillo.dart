...
class EditarPlatillo extends StatefulWidget {
  ...
  const EditarPlatillo(this.datos, this.info, {Key? key}) : super(key: key);
                      ...
                      if (formKey.currentState!.validate()) {
                        try {
                          ...
                          final respuesta = await http.Client().put(
                            Uri.http(
                              '10.0.2.2',
                              '/WebSservices-Comida/public/api/platillo/${info['id']}',
                              {
                          ...
                          if (respuesta.statusCode == 200) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text('Platillo actualizado'),
                              ),
                            );
